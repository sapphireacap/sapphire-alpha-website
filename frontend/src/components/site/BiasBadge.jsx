export const BiasBadge = ({ bias, testid }) => {
  const map = {
    ...
    Clear: { dot: "bg-emerald-400", text: "text-emerald-300", ring: "border-emerald-400/30 bg-emerald-400/10" },
    Caution: { dot: "bg-amber-400", text: "text-amber-300", ring: "border-amber-400/30 bg-amber-400/10" },
    Danger: { dot: "bg-red-400", text: "text-red-300", ring: "border-red-400/30 bg-red-400/10" },
  };
