...
const TOOLS = [
  ...
  { key: "sharpe", title: "Sharpe Dashboard", description: "Sharpe, Sortino, and max drawdown across the Nifty 500 — compare picks or view the top ranked.", active: true },
...
export default function QuantLab() {
  ...
  return (
    <div data-testid="quant-lab">
      ...
      {activeTool === "sharpe" && <SharpeDashboardTool />}
    </div>
  );
}
